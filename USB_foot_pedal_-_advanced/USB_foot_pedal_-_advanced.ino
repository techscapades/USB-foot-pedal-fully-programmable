 ...
 *   NicoHood HID library:
  https://github.com/NicoHood/HID //project root
  https://github.com/NicoHood/HID/tree/master/src/HID-APIs //APIs main folder
  https://github.com/NicoHood/HID/blob/master/src/HID-APIs/ConsumerAPI.h //for media functions
*/
